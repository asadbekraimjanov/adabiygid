<template>
    <div class="flex justify-between items-center py-6 border-b border-[#898686]">
        ...
        <el-button type="info" @click="viewMore" class="!bg-transparent !rounded-none z-50 !text-xl !py-7
                        hover:scale-[1.05] !font-medium" :disabled="true">Barchasini ko’rish</el-button>
    </div>
...
<!--                <img :src="`https://api.adabiygid.uz${item.newsDetails[0].attachment.url}`" class="w-full h-[30vh] transition-all hover:scale-125" alt="">-->
                <img :src="item.newsDetails[0].attachment.url" class="w-full h-[30vh] transition-all hover:scale-125" alt="">
            </div>
            ...
            <div class="w-full flex justify-between items-center py-4">
                ...
                <el-button type="info" @click="viewOne(item.id)" :icon="TopRight" :disabled="true"
